...
public class EmployeeValidator {
    public static List<String> validate(Employee e, Boolean code_duplicate_check_flag, Boolean password_check_flag){
        ...
        String code_error = _validateCode(e.getCode(), code_duplicate_check_flag, password_check_flag);
    ...
    private static String _validateCode(String code, Boolean code_duplicate_check_flag, Boolean password_check_flag){
